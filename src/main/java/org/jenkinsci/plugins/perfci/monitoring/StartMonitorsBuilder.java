...
public class StartMonitorsBuilder extends Builder {
    ...
    private boolean isAllMonitorsDisabled;

    @DataBoundConstructor
    public StartMonitorsBuilder(List<ResourceMonitor> monitors, boolean isAllMonitorsDisabled) {
        this.monitors = monitors != null ? monitors : Collections
                .<ResourceMonitor>emptyList();
        this.isAllMonitorsDisabled = isAllMonitorsDisabled;
    }
    ...
    public boolean getIsAllMonitorsDisabled() {
        return isAllMonitorsDisabled;
    }

    public void setIsAllMonitorsDisabled(boolean isAllMonitorsDisabled) {
        this.isAllMonitorsDisabled = isAllMonitorsDisabled;
    }
