...
public class NmonMonitor implements ResourceMonitor,
    ...
    public NmonMonitor(String host, String name, String password,
                       String interval, String outputPath, String fingerprint, boolean isDisabled) {
        this.host = host;
        this.name = name;
    ...
    public boolean start(String projectName, String buildID, String workspace,
        ...
        if (isDisabled) {
            LOGGER.info("WARNING: PerfCI will not start NMON monitor (" + this.host + ") according to your configuration.");
            listener.println("WARNING: PerfCI will not start NMON monitor (" + this.host + ") according to your configuration.");
            return true;
        }
        try {
