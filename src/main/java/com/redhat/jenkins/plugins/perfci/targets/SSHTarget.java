...
public class SSHTarget extends AbstractDescribableImpl<SSHTarget> implements MonitoringTarget<SSHTarget>, Serializable {
    ...
    public void connect() throws IOException, InterruptedException {
        ...
        if (fingerprint != null && !fingerprint.isEmpty()) {
            ...
            printConsole("WARNING: Fingerprint is not configured. The SSH connection is vulnerable to MIIT attack!");
        ...
        try {
            if (password != null && !password.isEmpty()) {
                printConsole("INFO: Authenticating with password...");
                ssh.authPassword(user, password);
            } else {
                printConsole("INFO: Authenticating with public key...");
    ...
    public RunCommandResult run(String executable, List<String> arguments, Map<String, String> envVars) throws IOException, InterruptedException {
        ...
        try (Session session = ssh.startSession()) {
            ...
            //printConsole("Actually running " + commandBuffer.toString());
            ...
            Future<String> stderrFuture = executor.submit(() -> {
                ...
                stderrReader.lines().collect(Collectors.joining("\n"));
                return sb.toString();
            });
